        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <a href="javascript: void(0)" data-href="<?= base_url('hasil/export/tidak-lulus') ?>" data-title="Tidak Lulus Try Out" class="btn btn-primary export-excel">Export ke Excel</a>
            </div>
            <div class="card-body">
